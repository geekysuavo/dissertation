...
less agressive scaling than UV by retaining partial covariance between
...
agressively select variables from multivariate data structures
\cite{lin:metab2011,wongravee:anchem2009}. While it is important to retain
only relevant variables for modeling, an over-agressive variable selection
