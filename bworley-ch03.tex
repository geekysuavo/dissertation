...
\begin{SCfigure}
\includegraphics[width=3.5in]{figs/mva/11.png}
\caption
...
\begin{SCfigure}
\includegraphics[width=3.5in]{figs/mva/12.png}
\caption
...
\begin{figure}[ht!]
\begin{center}
  \includegraphics[width=5.5in]{figs/mva/13.png}
\end{center}
\caption
...
\FORALL{$g \in \{1, \dots n_g\}$}
  \STATE $\{\mathbf{t}, \mathbf{p}, \mathbf{u}, \mathbf{c}, \mathbf{w}\}
          \gets \mathrm{PLS}(\mathbf{X}^{(-g)}, \mathbf{Y}^{(-g)})$ \COMMENT{
 $\mathbf{X}^{(-g)}$, $\mathbf{Y}^{(-g)}$ contain no rows from group $g$
}
