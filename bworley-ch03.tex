...
\cite{craig:anchem2006}. CS normalization does more harm than good, however,
...
a data structure. For example, variable stability (VAST) scaling multiplies
each element by the coefficient of variation of its variable in order to
focus on highly stable spectral features:
\begin{equation}
\tilde{x}_{nk}
...
the analyst with a standard PLS model that describes how the joint data in
...
over-complication in the multiblock regression schemes normally handled in
...
mis-classifications, and AUROC \cite{westerhuis:metab2008a} are a good first
