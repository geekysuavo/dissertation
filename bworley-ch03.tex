...
in scores space (\figref{3.9}{Figure 3.9B}). However, when the between-group
variation significantly contributes to the total variation in $\mathbf{X}$,
the groups will be well-separated (\figref{3.9}{3.9C}). Thus, PCA is a
...
\begin{figure}[ht!]
\begin{center}
  \includegraphics[width=5in]{figs/mva/13-assoc.png}
\end{center}
\caption
