...
median absolute deviation, respectively. \figref{7.1}{Figure 7.1} shows the
...
values are modeled as Gaussian white noise. \figref{7.2}{Figure 7.2} shows
an example remodeled spectrum from the ligand binding analysis of BSA.
\end{doublespace}

\begin{figure}[ht!]
\includegraphics[width=6in]{figs/ussr/02-ussrfit.png}
\caption
...
are reported in \figref{7.4}{Figure 7.4}.
\end{doublespace}
...
baseline from the screen spectra (e.g. \figref{7.3}{Figure 7.3}), resulting
...
collected \hnmr{} NMR spectra (\figref{7.5}{Figure 7.5}). Baseline estimates
...
(\figref{7.3}{Figure 7.3}), and correlations computed from PSC-normalized
...
illustrated in \figref{7.2}{Figure 7.2}. Removal of the interfering protein
statistical baseline from the screen spectrum (\figref{7.2}{Figure 7.2B})
...
non-binding ligands (\figref{7.2}{Figure 7.2A}). Only
