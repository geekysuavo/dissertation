...
\begin{abstract}
\begin{doublespace}
This dissertation includes chapters that have been adapted from articles and
communications published in peer-reviewed journals, as listed below:
\end{doublespace}
...
\begin{itemize}
  ...
  \item \bibentry{worley:cils2015b}
\end{itemize}
...
\begin{itemize}
  \item \bibentry{worley:cils2015a}
\end{itemize}
